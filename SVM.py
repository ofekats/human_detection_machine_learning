...
# Initialize SVM classifier for 128x128
svm_128 = SVC()

# Train SVM classifier with HOG features of size 128x128
print("Training SVM with HOG features of size 128x128...")
svm_128.fit(X_train_128, y_train_128)

# Predictions on training set for 128x128
y_train_pred_128 = svm_128.predict(X_train_128)
...
y_pred_128 = svm_128.predict(X_test_128)
...
# Initialize SVM classifier for 64x64
svm_64 = SVC()

# Train SVM classifier with HOG features of size 64x64
print("Training SVM with HOG features of size 64x64...")
svm_64.fit(X_train_64, y_train_64)

# Predictions on training set for 64x64
y_train_pred_64 = svm_64.predict(X_train_64)
...
y_pred_64 = svm_64.predict(X_test_64)
...
plt.title('Training and Testing Accuracy of SVM with HOG features')
plt.show()
